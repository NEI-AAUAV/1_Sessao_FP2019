...
T = float(input("Temperature (K)? ")) #7b
P = float(input("Pressure (kPa)? "))  #7b

# Determine the phase. (This is wrong! Fix to match phase diagram.)
if T > 400.0 and P > 50.0:
    phase = "LIQUID"
elif P > 50.0 or (T/P >= 4.0 and P < 50.0):
    phase = "SOLID"
else:
    phase = "GAS"

# Output.  (There's a subtle syntax error here!)
print("At {:.1f} K and {:.3f} kPa, Kryptonite is in the {} phase.".format(T, P, phase)) #7a)
